...
def natas_connect(website: str, username: str = None, password: str = None, params: dict = None, headers: dict = None, cookies: dict = None, get_body: bool = True) -> tuple[requests.Response, bs4.Tag]:
    ...
    r = requests.get(website, auth=(username, password), params=params, headers=headers, cookies=cookies)
...
def find_element(element: str, soup: bs4.BeautifulSoup | bs4.Tag , all: bool = True) -> bs4.Tag:
...
response, soup = natas_connect(website=website, username=username, password=password)

response, soup = natas_connect(website=website, username=username, password=password, cookies={"loggedin": "1"})
