...
res = "MGw7JCQ5OC04PT8jOSpqdmk3LT9pYmouLC0nICQ8anZpbS4qLSguKmkz"

final_response, final_soup = send_get_request(website=website, username=username, password=password, cookies={"data": res})
